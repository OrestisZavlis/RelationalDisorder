...
## Introduction
This repository includes code on a model that formalizes (static) personality disorders as (dynamic) relational disorders, using the computational process of mental inference. 
